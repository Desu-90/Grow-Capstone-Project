...
if (window.location.href === 'http://127.0.0.1:5500/client/paper.html' || window.location.href === 'http://127.0.0.1:5500/client/mason.html' || window.location.href === 'http://127.0.0.1:5500/client/glass.html'|| window.location.pathname.startsWith('/client/paper.html')|| window.location.pathname.startsWith('/client/glass.html')|| window.location.pathname.startsWith('/client/mason.html')) {
...
restartButton.addEventListener('click', () => {
    if(window.location.href === 'http://127.0.0.1:5500/client/paper.html' || window.location.pathname.startsWith('/client/paper.html')){
    ...
    if(window.location.href === 'http://127.0.0.1:5500/client/mason.html'|| window.location.pathname.startsWith('/client/paper.html')){
        const image1HTML = '<img id="masonB" src="../assets/mason_back.png">'
        const image2HTML = '<img id="masonF" src="../assets/mason_front.png">'
        canvas.innerHTML = image1HTML + image2HTML
    }
    if(window.location.href === 'http://127.0.0.1:5500/client/glass.html'|| window.location.pathname.startsWith('/client/paper.html')){
